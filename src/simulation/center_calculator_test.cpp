// ==========================================================
// center_calculator_test.cpp — Test for Center Calculator Functions
// ==========================================================
...
void test_nosecone_and_finset() {
    ...
    std::cout << "  Nose cone area: " << std::fixed << std::setprecision(2) << nosecone_area << " m², center: " << nosecone_center << " m" << std::endl;
